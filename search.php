...
<?php 
	...
	$villas=query_posts($query_string . '&posts_per_page=-1&orderby=date&orderDESC=DESC&post_status=publish'); 
	$fields=get_fields(170);
			...
			<div class="container">
				...
				<div id="listing-villa-filter">
					<!-- <div id="listing-villa-filter-left">
						<?php
						/*
						<a href="#" title="<?php _e("Open filter", "onestbarts"); ?>" id="open-filter-2"><i class="fa fa-sliders"></i></a>
						*/
						?>
