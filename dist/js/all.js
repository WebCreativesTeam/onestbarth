...
jQuery(document).ready(function() {
    ...
    if ($("#listing").length > 0) {
        $("#open-filter").on("click", function() {
            ...
            e = $(this).parents(".filter_wrapper").find("#select-bedrooms").val(), locationTab = $(this).parents(".filter_wrapper").find("#select-location").val(), collectionTab = $(this).parents(".filter_wrapper").find("#select-collections").val();
            var t = "";
            if (null != e) {
            ...
            return $.post(ajaxurl, {
                ...
                dateArrival: $(this).parents(".filter_wrapper").find("#input-arrival").val(),
                dateDeparture: $(this).parents(".filter_wrapper").find("#input-departure").val(),
                priceMin: $(this).parents(".filter_wrapper").find("#price-min span").text(),
                priceMax: $(this).parents(".filter_wrapper").find("#price-max span").text(),
                bedroom: t,
                location: i,
                collection: a,
                tri: $("#filter-tri").val()
    ...
    if ($(".single-villa").length > 0) {
        ...
        if (c.owlCarousel({
                ...
                // console.log(e), 
                e.target !== this ? "diaporama-villa-header" != e.target.id && "" != e.target.id || "diapo-img" != e.target.className && "fa" != e.target.classList[0] && "owl-next" != e.target.className && "owl-prev" != e.target.className && "owl-stage" != e.target.className && $("#diaporama-villa").removeClass("active") : $("#diaporama-villa").removeClass("active")
            }), $(document).width() > 768) {
            var p = $("#single-booking").offset();
            $(window).scroll(function() {
                // console.log(p), 
                $(window).scrollTop() > p.top - 60 ? $("#single-booking").addClass("fixed") : $("#single-booking").removeClass("fixed")
            })
        }
    ...
    if ($("#favorite").length > 0 && (pickmeup("#arrival", {
            format: "Y-m-d"
        }), pickmeup("#departure", {
            format: "Y-m-d"
    ...
    $("#template-transfert").length > 0 && ($(".article-slider").owlCarousel({
        loop: !0,
        margin: 0,
        nav: !0,
        dots: !1,
    ...
    })), $("#template-philosophy").length > 0 && $("#philosophy-collections .owl-carousel").owlCarousel({
        loop: !0,
        margin: 0,
        nav: !0,
        dots: !1,
...
$(document).ready(function () {
    ...
    $(function() {
        var owl = $("#home-experiences-content"),
            owlOptions = {
                loop: false,
                margin: 10,
                responsive: {
...
jQuery("#open-booking2").click(function($){
	$= jQuery;
...
function myFunction() {
  ...
  jQuery(".rightar a").toggleClass("open");
