 <?php
/*
Template Name: Template - Listing Rental
*/
?>
<?php get_header(); ?>
<?php
...
<div id="listing" class="listing">
	...
	<!--<div id="listing-filter" style="display:block !important">
...
<div class="mobile_div" style="display:none;"> 
<div class="topnav">
  <div class="leftar">REFINE YOUR SEARCH</div>
  <div class="rightar">
  ...
  <div id="myLinks" style="display:none">
   <?php echo display_filter_mobile(); ?>
  </div>
		...
		<div id="listing-filter" style="display:block !important">
			...
			<?php echo display_filter(); ?>
					...
					if(!empty($villas))
					{
						...
						foreach($villas as $key => $oV)
						{
							...
							foreach($_SESSION['money'] as $name => $sigle){
                                ...
                                $priceTmp = get_post_custom_values('villa_price_from', $oV->ID)[0];
                                //echo get_post_custom_values('villa_rates_0_bedrooms_infos_2_price_dollar', $oV->ID)[0];
				...
				<div id="listing-loading"></div>
					<div class="bg">
					<div class="container">
				<h2 class="headeing  black fontcustmon">WHY ONE ST BARTS</h2>
				<div class="row black">
				  <div class="col-xs-6 col-md-4 text-center">
						<h2 class="black">The Finest Handpicked Homes</h2>
						<p>We handpick and visit every home in person of our collection to propose you unique properties. We look for space, design and comfort. Get expert advice from our reservations team whose only objective is you find the best place for your stay. </p>
				  </div>
				  <div class="col-xs-6 col-md-4 text-center">
					<h2 class="black">A New Brand of Hospitality</h2>
						<p>We offer an unprecedented level of service and care during your stay in our beautiful homes. We prepare every property with the highest attention: a friendly face to welcome you, French toiletries, gift basket, professional cleaning, free WiFi… and more.</p>
				  </div>
				  <div class="col-xs-6  col-md-4  text-center">
					<h2 class="black">At Home Far Away from Home</h2>
						<p>Our welcome team prepares homes with toiletries, gift basket, flower, bottled water, a selection of tea and coffee, and more surprises… to feel at home far away from home. We welcome you in person at your arrival and escort you to your villa. </p>
				  </div>
			
				  <div class="col-xs-6 col-md-4 text-center">
						<h2 class="black">Best price guarantee</h2>
						<p>We guarantee booking directly with One St Barts you get the best offers possible price for your stay. Don't hesitate to contact us to ask about rates and availability if you are interested in a villa. Our Team will get back to you within hours.</p>
				  </div>
				  <div class="col-xs-6 col-md-4 text-center">
					<h2 class="black">A New Brand of Hospitality</h2>
						<p>Ask our concierge team for a special service or unique experience to truly elevate your holiday. Tailor-made activities for families, honeymoon cruises, water sports activities and helicopter sightseeing will make your stay at your villa all that more special.</p>
				  </div>
				  <div class="col-xs-6  col-md-4  text-center">
					<h2 class="black">Upgrade & Enhance Your Stay</h2>
						<p>St Barths is a sophisticated Caribbean playground with all nature’s bare pleasures. Upgrade your stay to make all your arrangements. Diving lessons, golf in Anguilla. Bringing a picnic with iced drinks. It is our greatest delight to provide those services. </p>
				  </div>
				  </div>
				...
				<div id="listing-villa-footer">
					...
					<div id="listing-villa-footer-right">
						<p class="subtitle">PREFER A MORE PERSONALIZED APPROACH?</p>
						<h3><?php/* echo $fields['rental_form_title']; */?>We Can Help!</h3>
						<p class="subtitle"><?php echo $fields['rental_form_subtitle']; ?></p>
						
						<?php echo do_shortcode( '[gravityform id="10" title="true" description="true"]' );  ?>
