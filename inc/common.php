...
function display_filter(){
	...
	<div class="filter-container">
		<p class="placeholder"> Refine Your Search</p>
	</div>
	...
	<div id="filter-location" class="filter-container">
		<select name="selectlocation[]" id="select-location" class="select2-multiple" multiple="multiple" data-placeholder="<?php _e("Locations", "onestbarts"); ?>">
			<?php
	...
	<div id="filter-collections" class="filter-container">
		<select name="selectcollections[]" id="select-collections" class="select2-multiple" multiple="multiple" data-placeholder="<?php _e("Collection", "onestbarts"); ?>">
			<?php
	...
	<div id="filter-reset" class="filter-container">
		<a href="<?php echo site_url();?>/villa-rental/" title="<?php _e("Reset","onestbarts"); ?>"><?php _e("Reset","onestbarts"); ?></a>
	</div>
...
function display_filter_mobile(){
	$locations = get_terms( 'location', array('hide_empty' => false,));
	$collections = get_terms( 'collection', array('hide_empty' => false,));
...
{
	$villaRates=get_field('villa_rates',$_SESSION['booking']['idvilla']);//get_post_custom_values('villa_price_from', $_SESSION['booking']['idvilla'])[0];
	/*echo '<pre>';
	print_r($villaRates);
	echo '</pre>';*/
	$price=0;
